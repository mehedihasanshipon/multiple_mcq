                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr v-for="(answer,index) in answers.answers" :key="index" class="bg-white">
                                ...
                                <td class="px-3 py-2 lg:px-6 lg:py-3 whitespace-nowrap text-sm text-gray-900">
                                 ...
                                 <td class="px-3 py-2 lg:px-6 lg:py-3 whitespace-nowrap text-sm text-gray-900">
                                    <Switch v-model="answer.isCorrect" @click="isCorrectAnswer(answer)"
                                        ...
                                        <span aria-hidden="true"
                                              :class="[answer.isCorrect ? 'bg-indigo-600' : 'bg-gray-200', 'pointer-events-none absolute h-4 w-9 mx-auto rounded-full transition-colors ease-in-out duration-200']"/>
                                        <span aria-hidden="true"
                                              :class="[answer.isCorrect ? 'translate-x-5' : 'translate-x-0', 'pointer-events-none absolute left-0 inline-block h-5 w-5 border border-gray-200 rounded-full bg-white shadow transform ring-0 transition-transform ease-in-out duration-200']"/>
                                    </Switch>
                                </td>
                            </tr>
                            </tbody>
